...
from ..tl.types import (
    ...
    MsgNewDetailedInfo, NewSessionCreated, MsgDetailedInfo, HttpWait
)
from ..errors import PhoneMigrateError
...
class MtProtoSender:
    ...
    def _process_msg(self, msg_id, sequence, reader, state):
        ...
        if isinstance(obj, HttpWait):
            return self._handle_http_wait_response(msg_id, sequence, obj)
    ...
    def _handle_rpc_result(self, msg_id, sequence, reader):
        ...
        if inner_code == 0x2144ca19:  # RPC Error
            ...
            if hasattr(request.rpc_error, 'new_dc'):
                raise PhoneMigrateError(capture=request.rpc_error.new_dc)
